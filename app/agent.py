...
from app.processing import extract_recipe, interpret_recipe, post_process_recipe
from app.acquisition import fetch_html_from_url, extract_text_from_images
from utils import simulate_stream, extract_function_call, handle_function_call
